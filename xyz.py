...
parser = argparse.ArgumentParser(
    prog='xyz', description='XYZ Studio Project Inspector.')
subparsers = parser.add_subparsers(
    help='Managing projects, spaces, feautres', dest='operation')
...
parser_project.add_argument(
    '--show', action='store_const', const=True, help='Show also the Project Json')
parser_project.add_argument('--spaces', action='store_const', const=True,
                            help='Show also the list of spaces related to the Project')

parser_project.set_defaults(func=input_project)

parser_space = subparsers.add_parser('space', help='Managing XYZ Spaces')
parser_space.add_argument('--list', action='store_const',
                          const=True, help='Show all spaces')
...
parser_space.add_argument(
    '--statistics', action='store_const', const=True, help='Include Statistics')
parser_space.set_defaults(func=input_space)

parser_features = subparsers.add_parser(
    'feature', help='Managing XYZ Features')
